package com.Infiniteloop.TogetherPlay.speaker;
...
import com.Infiniteloop.TogetherPlay.R;
import com.Infiniteloop.TogetherPlay.Timer;
import com.Infiniteloop.TogetherPlay.speaker.ClientDeviceListFragment.SpeakerFragmentListener;
...
public class SpeakerActivity extends Activity implements ChannelListener,
    ...
    public NdefMessage createNdefMessage(NfcEvent event) {
        ...
        NdefMessage msg = new NdefMessage(NdefRecord.createMime(
                "application/com.Infiniteloop.TogetherPlay", myMac.getBytes())
        );
        return msg;
    }
