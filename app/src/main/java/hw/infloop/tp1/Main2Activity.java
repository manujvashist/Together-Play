        ...
        btnCall.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(selectedButton == -1) {
                    ...
                    final AlertDialog alert = new AlertDialog.Builder(Main2Activity.this).create();
                    alert.setTitle("Oops");
                ...
                Intent intent = new Intent(Main2Activity.this, MakeCallActivity.class);
                    ...
                    while(LISTEN) {
                        ...
                        try {
                            ...
                            if(action.equals("CAL:")) {
                                ...
                                Intent intent = new Intent(Main2Activity.this, ReceiveCallActivity.class);
