...
public class MakeCallActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		displayName = intent.getStringExtra(Main2Activity.EXTRA_DISPLAYNAME);
		contactName = intent.getStringExtra(Main2Activity.EXTRA_CONTACT);
		contactIp = intent.getStringExtra(Main2Activity.EXTRA_IP);
